...
function calculercapitalRestantDu(
    ...
    var dateDebutPret = moment(dateString, "DD-MM-YYYY").format("YYYY-MM-DD");
...
$("#go_calcule, #differe-next , triggerTarifs").click(function() {
    ...
    $('#mensualit-sans-assurance').text("Si vous ne savez pas, voici le montant de votre mensualité sans assurance : " + mensualite + "€.(Vous pouvez l'utiliser comme indicateurpour en déduire le montant)");
