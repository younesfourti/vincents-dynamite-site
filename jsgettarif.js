...
async function updateListWithAPIdata(token) {
    ...
    data.organismes_preteurs.forEach(function(org) {
        const $option = $("<option>").val(org.id_organisme_preteur).text(org.raison_sociale);
...
async function GetTariffs(token) {
    ...
    $("#cotisation_echeance_moyenne").attr("fs-numbercount-end", data.Tarif_global.cotisation_echeance_moyenne);
    $("#cotisation_echeance").attr("fs-numbercount-end", data.Tarif_global.cotisation_echeance);
    $("#cotisation_totale").attr("fs-numbercount-end", data.Tarif_pret[0].cotisation_totale);
    $("#cotisation_annuelle_moyenne").attr("fs-numbercount-end", data.Tarif_pret[0].cotisation_annuelle_moyenne);
    $("#taux_moyen").attr("fs-numbercount-end", data.Tarif_beneficiaire[0].Echeanciers[0].taux_moyen);
    $("#cotisation_8ans").attr("fs-numbercount-end", data.Tarif_beneficiaire[0].Echeanciers[0].cotisation_8ans);
    ...
    script.src = "https://cdn.jsdelivr.net/npm/@finsweet/attributes-numbercount@1/numbercount.js";
    script.defer = !0;
